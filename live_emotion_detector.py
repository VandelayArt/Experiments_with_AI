...
while True:
    ...
    combined_result = (emotion + "," + gender + "," + str(age) + "," + race) 
    ...
    # Defining the text to show on screen by a series of if statements
        # If happy
    if emotion == "happy":    
        cv2.putText(frame, "Love your smile", (100,350), font, 1,
                    (randrange(256), randrange(256), randrange(256)),
                    2, cv2.LINE_4
                )
        # If sad
    elif emotion == "sad":
        cv2.putText(frame, "Cheer up Buttercup", (100,350), font, 1,
                    (randrange(256), randrange(256), randrange(256)),
                    2, cv2.LINE_4
                )
        # If angry
    elif emotion == "angry":
        cv2.putText(frame, "Why so serious?", (100,350), font, 1,
                    (randrange(256), randrange(256), randrange(256)),
                    2, cv2.LINE_4
                )
        # If surprised        
    elif emotion == "surprise":
        cv2.putText(frame, "Scared you there didn't I?", (100,350), font, 1,
                    (randrange(256), randrange(256), randrange(256)),
                    2, cv2.LINE_4
                )
        # If no specific emotion is recognized
    elif emotion == "neutral":
        cv2.putText(frame, "Someone's in a mood...", (100,350), font, 1,
                    (randrange(256), randrange(256), randrange(256)),
                    2, cv2.LINE_4
                )
